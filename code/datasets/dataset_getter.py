...
from datasets.optitrack_sequential import OptitrackDatasetSequential, OptitrackModelDatasetSequential
...
def get_model_sequence_loaders(args, mode):
    batch_size = getattr(args, f"{mode}_batch_size")

    train_dataset = OptitrackModelDatasetSequential(
        csv_file=args.common_dataset_path,
        subsample_all=args.common_downsample_all,
        Ts_multiplier=args.common_Ts_mult,
        check_new_run=True,
    ...
    test_dataset = OptitrackModelDatasetSequential(
        csv_file=args.common_dataset_path,
        subsample_all=args.common_downsample_all,
        Ts_multiplier=args.common_Ts_mult,
        check_new_run=True,
